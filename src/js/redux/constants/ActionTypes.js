...
export const ACTION_GET_ABOUT_TEXT = 'ACTION_GET_ABOUT_TEXT';
export const ACTION_SAVE_ABOUT = 'ACTION_SAVE_ABOUT';
export const ACTION_IMAGE_CHANGE = 'ACTION_IMAGE_CHANGE';
